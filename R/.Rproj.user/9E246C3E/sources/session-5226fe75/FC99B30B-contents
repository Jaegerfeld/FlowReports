...
# fortlaufende Summe bilden "Tag1 + Tag2 + TagN..."
...
# "Einzelne Status pro Tag" untereinander sortieren , erst alle Funnel, dann alle Analysis etc.

df <- melt(df, id.vars='Day')

# Situation am Start Date Tag
...
# Situation am Last date Tag (letzter erfasster Tag)
